...
export default function Home() {
  ...
  const fetchNews = async () => {
    try {
      ...
      if (!response.ok) {
        throw new Error('An error occurred while loading the news');
      }
    ...
    <>
      <main className="min-h-screen">
        ...
        <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden bg-black">
          ...
          <div className="relative container mx-auto px-4 text-center z-10">
            ...
            <p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
              I am a <span className="text-blue-400">Computer Engineer</span> who develops projects in the fields of artificial intelligence, image processing, and software development.
            </p>
                ...
                <div className="space-y-6">
                  <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/10 hover:border-blue-500/30 transition-all duration-300">
                    <p className="leading-relaxed text-gray-300">
                      Hello, I'm Yakup Kutluksaman. I am a Computer Engineer passionately dedicated to the fields of artificial intelligence, image processing, and software development. I am currently pursuing my bachelor's degree in Computer Engineering at Iskenderun Technical University.
                    </p>
                  </div>
                  ...
                  <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/10 hover:border-purple-500/30 transition-all duration-300">
                    <p className="leading-relaxed text-gray-300">
                      Throughout my academic journey, as a student with a GPA of 3.1, I have developed a special interest in courses such as artificial intelligence, machine learning, and object-oriented programming. I continuously strive to improve myself and learn new technologies in these areas.
                    </p>
                  </div>
                  ...
                  <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-white/10 hover:border-green-500/30 transition-all duration-300">
                    <p className="leading-relaxed text-gray-300">
                      Particularly in the field of image processing, I have developed projects using techniques such as histogram equalization, HSV color space, and dynamic clustering. Additionally, I am working on large language models (LLMs) and artificial intelligence technologies.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
                ...
                <div className="space-y-6">
                  ...
                  <div className="group/item hover:bg-white/5 p-4 rounded-xl transition-all">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-lg font-medium text-purple-400 mb-2">LLM's</h4>
                        <p className="text-gray-400 text-sm">Chatbot development and natural language processing applications with large language models</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group/item hover:bg-white/5 p-4 rounded-xl transition-all">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">YOLO, MediaPipe, and specialized CNN models for object detection and classification</p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10 hover:border-orange-500/30 transition-all duration-500 group">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="text-2xl font-semibold text-white">Tools & IDE's</h3>
                </div>
                ...
                <div className="space-y-6">
                  <div className="group/item hover:bg-white/5 p-4 rounded-xl transition-all">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">VS Code, PyCharm, Jupyter Notebook for professional development experience</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group/item hover:bg-white/5 p-4 rounded-xl transition-all">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-lg font-medium text-orange-400 mb-2">AI-Supported Development</h4>
                        <p className="text-gray-400 text-sm">Cursor IDE for AI pair programming and intelligent code completion</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group/item hover:bg-white/5 p-4 rounded-xl transition-all">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">Automating development processes with custom AI agents</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
              ...
              <div className="group relative bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden transition-all duration-500 hover:border-blue-500/30">
                ...
                <div className="relative p-8">
                  ...
                  <p className="text-gray-300 mb-6 leading-relaxed">
                    I developed an AI model that processes camera input to convert sign language to text and text to speech. This system aims to facilitate communication for visually and hearing-impaired individuals.
                  </p>
                    ...
                    <div className="bg-white/5 rounded-xl p-4 backdrop-blur-sm">
                      ...
                      <ul className="space-y-2 text-gray-300">
                        <li className="flex items-center gap-2">
                          ...
                          Real-time hand movement analysis
                        </li>
                        <li className="flex items-center gap-2">
                          <span className="text-blue-400">◆</span>
              ...
              <div className="group relative bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden transition-all duration-500 hover:border-green-500/30">
                ...
                <div className="relative p-8">
                  ...
                  <p className="text-gray-300 mb-6 leading-relaxed">
                    This project, supported by TÜBİTAK 2209-A, involves developing a software application to optimize lighting conditions for plant growth in soilless farming systems.
                  </p>
              ...
              <div className="group relative bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden transition-all duration-500 hover:border-purple-500/30">
                ...
                <div className="relative p-8">
                  ...
                  <p className="text-gray-300 mb-6 leading-relaxed">
                    I developed an image processing algorithm capable of analyzing colors, percentages, and bar chart levels in graphical data. Additionally, I designed a chatbot that allows users to ask questions about charts and receive comprehensive, analysis-focused responses based on processed data.
                  </p>
                  ...
                  <div className="space-y-4">
                    <div className="bg-white/5 rounded-xl p-4 backdrop-blur-sm">
                      ...
                      <ul className="space-y-2 text-gray-300">
                        ...
                        <li className="flex items-center gap-2">
                          <span className="text-purple-400">◆</span>
                          LLM support for interpretation
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div className="group relative bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden transition-all duration-500 hover:border-red-500/30">
                ...
                <div className="relative p-8">
                  <div className="flex items-center gap-6 mb-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-white mb-2">Akıllı Robot Asistan</h3>
                      <div className="flex flex-wrap gap-2">
                  ...
                  <p className="text-gray-300 mb-6 leading-relaxed">
                    Raspberry Pi tabanlı, görüntü işleme ve nesne tanıma yetenekleriyle donatılmış, çeşitli oyunlar oynayabilen bir robot asistan geliştiriyorum. Proje halen geliştirme aşamasında olup, yapay zeka ve robotik alanındaki yeteneklerimi birleştirdiğim bir çalışma.
                  </p>

                  <div className="space-y-4">
                    <div className="bg-white/5 rounded-xl p-4 backdrop-blur-sm">
                      <h4 className="text-white font-semibold mb-3">Geliştirme Aşamaları:</h4>
                      <ul className="space-y-2 text-gray-300">
                        <li className="flex items-center gap-2">
                          <span className="text-red-400">◆</span>
                          Gerçek zamanlı nesne tanıma ve takibi
                        </li>
                        <li className="flex items-center gap-2">
                          <span className="text-red-400">◆</span>
                          Raspberry Pi ile donanım entegrasyonu
                        </li>
                        <li className="flex items-center gap-2">
                          <span className="text-red-400">◆</span>
                  ...
                  <div className="mt-6 pt-6 border-t border-white/10">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-sm text-white">Geliştirme Aşamasında</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section id="news" className="py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <h2 className="text-3xl font-bold text-center mb-16 text-white">Güncel AI Haberleri</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
              {isLoading ? (
                ...
                <div className="col-span-3 text-center text-gray-400">
                  {error || 'Haber yüklenirken bir hata oluştu. Lütfen daha sonra tekrar deneyin.'}
                </div>
              )}
            </div>
          </div>
        ...
        <section id="contact" className="py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <h2 className="text-3xl font-bold text-center mb-16 text-white">İletişime Geç</h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-8">
                  <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10">
                    <h3 className="text-2xl font-semibold text-white mb-6">Bana Ulaşın</h3>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-white">İzmir, Konak</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10">
                  ...
                  <form
                    onSubmit={(e) => {
                      ...
                      const mailtoLink = `mailto:yakup.kutluksaman1@gmail.com?subject=${encodeURIComponent(`${subject} - from ${name}`)}&body=${encodeURIComponent(`Gönderen: ${name}\nE-posta: ${email}\n\nMesaj:\n${message}`)}`;
                  ...
                  >
                    <div className="space-y-2">
                      <label htmlFor="name" className="text-sm text-gray-300">İsim</label>
                      <input
                        type="text"
                        id="name"
                        name="name"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="subject" className="text-sm text-gray-300">Konu</label>
                      <input
                        type="text"
                        id="subject"
                        name="subject"
                    ...
                    <div className="space-y-2">
                      <label htmlFor="message" className="text-sm text-gray-300">Mesaj</label>
                      <textarea
                        id="message"
                        name="message"
                        required
